...
```{=tex}
\begin{align} 
\text{HappinessScore}_i &\sim \mbox{Normal}(\mu_i, \sigma) \\
\mu_i &= \alpha + \beta \times \text{GiniIndex}_i\\
...
```{=tex}
\begin{align} 
\text{Happiness\_score}_i &= \beta_0 + \beta_1 \times \text{Democracy\_index}_i + \beta_2 \times \text{Gini\_index}_i + \beta_3 \times \text{IHDI}_i + \varepsilon_i \\
